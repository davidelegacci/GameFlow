...
CURRENT_FOLDER = "3_player_zero_sum"
EXPERIMENT_NAME = "3_player_zero_sum"
...
# payoff = [3, 1, 2, 0, 0, 1, 0, 0, 1, 3, 0, 2, 1, 0, 0, 0, 3, 3, 2, 2, 1, 1, 0, 0]
# payoff = [-8, 10, 6, -1, -2, 4, 4, 1, -3, 1, 1, -3, -3, -2, -3, -2, 9, -1, -4, 2, -4, 2, -3, -5]
...
########################################################
# 222 zero-sum in candogan format 2025-07-05
payoff = [0, -1, -1, 2, 2, -1, -1, 0, 0, -1, 2, -1, -1, 2, -1, 0, 0, 2, -1, -1, -1, -1, 2, 0]
########################################################
...
EGMD = plot_algo(extra_gradient_mirror_descent, "Extra gradient mirror descent", x0 = initial_point, num_iterations = NUM_ITER, color =  "green")
...
save_experiment(EXPERIMENT_NAME, "Three player zero sum")  # <------------------------------------ save
